...
// https://whitewell.sakura.ne.jp/PCL/OpenNI_tutorial_3_Cloud_processing_advanced.html
...
preprocess(const pcl::PointCloud<pcl::PointXYZ>::Ptr src);
...
int main(void)
{
  ...
  std::string pcd1 = "/root/catkin_ws/src/bunny/data/bun000.ply";
  std::string pcd2 = "/root/catkin_ws/src/bunny/data/bun045.ply";
